...
class CourseOrg(models.Model):
    ...
    tag = models.CharField(max_length=10, default=u"著名机构", verbose_name=u"机构标签")
...
class Teacher(models.Model):
    ...
    # 可以使我们通过讲师找到对应的机构
    org = models.ForeignKey(CourseOrg, on_delete=models.CASCADE, verbose_name=u"所属机构", name='')
